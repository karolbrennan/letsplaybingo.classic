					...
					<div className="row">
						<div className="col c50">
							<div className="logo-block">
								...
								<span className="logo-title">Classic Edition - RETIRED</span>
							</div>
						</div>
				...
				<section>
					<div className="row">
						...
						<div className="col c75 padding">
							<h2>Classic Edition is no longer supported</h2>
							...
							<p className="small-text">
								This version is being kept online for archival purposes only. It
								contains bugs and issues that will not be fixed. Use at your own
								risk. Please see the latest verion which has many new features,
								over a thousand new bingo patterns to choose from, true
								randomization of all calls, and a brand new layout option
								similar to this one!
							</p>
						</div>
					</div>
